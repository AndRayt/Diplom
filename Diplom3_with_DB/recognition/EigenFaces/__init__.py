...
class EigenFacesRecognition:
    ...
    def __init__(self, x_face_size=120, y_face_size=120):
        ...
        self.recog = cv2.face.EigenFaceRecognizer_create(23, 25000.0)
    ...
    def traning(self, detector_type=HAAR_CASCADES,
                file_path="C:\\Users\\Andrew\\PycharmProjects\\Diplom3_with_DB\\recognition\\EigenFaces\\dump_data\\face_classifier.xml",
        ...
        file.close()
        print("[INFO] сохранение обученной модели распознователя лиц EigenFaces...")
        self.recog.save(file_path)

    def human_recognition(self, frame, face_box,
                          face_recog_path="C:\\Users\\Andrew\\PycharmProjects\\Diplom3_with_DB\\recognition\\EigenFaces\\dump_data\\face_classifier.xml"):
